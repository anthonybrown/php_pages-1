...
<body>
  ...
  <div id="wrapper">
	...
	<h1>Get in touch</h1>
		...
		<h2>
			<span class="red">&hearts;</span>&nbsp; <sapn class="aqua">&diams;</sapn>&nbsp;
			<span class='yellow'>&clubs;</span>&nbsp;<span class="orange">&spades;</span>
		</h2>
	</header>
	<div id="main" role="main">
		<h1>Contact Page</h1>
		<p>Hey what's up boys and girls? What are we all up to tonigh?</p>
	</div>
