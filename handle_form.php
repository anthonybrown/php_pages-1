...
<?php
	...
	$com = $_POST['comments'];
	$title = $_POST['title'];
	$feed = $_POST['form_page'];
	
	echo "<p>Thank you there, $title $name, for your response.</p>
		<p>You stated that you found this example to be, $respo, and added that 
		$com<br /> from the file named: $feed</p>
	"
